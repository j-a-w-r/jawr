 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/generator/skin/standard/config/web.xml", jawrConfig = "net/jawr/web/generator/skin/debug/config/jawr.properties")
public class MainPageGeneratedResourceSkinLocaleFrDebugTest extends MainPageGeneratedResourceSkinTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/debug/resources/index-jsp-result-locale-fr-debug-mode-expected.txt", page);
	}
	...
	public void testJsBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/debug/resources/msg-debug-fr.js", page);
	...
	public void testCssBundleContent() throws Exception {
		...
		css = (HtmlLink) styleSheets.get(2);
		page = getCssPage(css);
		assertContentEquals("/net/jawr/web/generator/skin/debug/resources/theme_summer_fr.css", page);
		
		css = (HtmlLink) styleSheets.get(3);
		page = getCssPage(css);
		assertContentEquals("/net/jawr/web/generator/skin/debug/resources/theme1_summer_fr.css", page);
	}
