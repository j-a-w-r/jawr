 ...
 */
@JawrTestConfigFiles( webXml="net/jawr/web/standard/config/web.xml", jawrConfig="net/jawr/web/locale/config/jawr-namespace-filter.properties")
public class MainPageLocaleFrNamespaceFilterTest extends MainPageTest {
