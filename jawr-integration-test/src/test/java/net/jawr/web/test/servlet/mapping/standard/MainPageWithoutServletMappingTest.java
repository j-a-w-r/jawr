...
/**
 * Test case for page without servlet mapping in production mode.
 * 
 * @author ibrahim Chaehoi
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/servlet/mapping/config/web-without-servlet-mapping.xml", jawrConfig = "net/jawr/web/servlet/mapping/config/jawr.properties")
public class MainPageWithoutServletMappingTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/index-jsp-result-expected.txt", page);
	}
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/component-expected.css", page);
	}
