...
public class MainPageGeneratedResourceSkinDebugTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/debug/resources/index-jsp-result-debug-mode-expected.txt", page);
	}
