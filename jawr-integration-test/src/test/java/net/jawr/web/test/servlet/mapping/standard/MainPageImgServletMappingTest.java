...
/**
 * Test case for page using Image servlet mapping in production mode.
 * 
 * @author ibrahim Chaehoi
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/servlet/mapping/config/web-img-servlet-mapping.xml", jawrConfig = "net/jawr/web/servlet/mapping/config/jawr.properties")
public class MainPageImgServletMappingTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/index-jsp-img-servlet-mapping-result-expected.txt", page);
	}
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(
				CONTEXT_PATH+"/N1515795919/fwk/core/component.css",
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/component-img-servlet-mapping-expected.css", page);
	}
