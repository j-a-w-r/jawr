 ...
 */
@JawrTestConfigFiles( webXml="net/jawr/web/standard/config/web.xml", jawrConfig="net/jawr/web/locale/config/jawr-custom-message-generator-namespace-filter.properties")
public class MainPageLocaleFrCustomMessageGeneratorNamespaceFilterTest extends MainPageTest {
	...
	public void testJsBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/locale/resources/msg-bundle-fr-namespace-filter.js", page);
	}
