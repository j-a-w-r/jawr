...
public class MainPageGeneratedResourceSkinLocaleFrTest extends MainPageGeneratedResourceSkinTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/standard/resources/index-jsp-result-locale-fr-expected.txt", page);
	}
	...
	public void testJsBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/standard/resources/msg-bundle-fr.js", page);
	}
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/standard/resources/component-locale-fr-expected.css", page);
	}
