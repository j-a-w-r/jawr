...
/**
 * Test case for page using JS and CSS servlet mapping in production mode.
 * 
 * @author ibrahim Chaehoi
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/servlet/mapping/config/web-js-css-servlet-mapping.xml", jawrConfig = "net/jawr/web/servlet/mapping/config/jawr.properties")
public class MainPageJsCssServletMappingTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/index-jsp-js-css-servlet-mapping-result-expected.txt", page);
	}
	...
	public void checkGeneratedJsLinks() {
		...
		assertEquals(
				CONTEXT_PATH+"/jsJawr/1542603560.en_US/js/bundle/msg.js",
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(
				CONTEXT_PATH+"/cssJawr/N588763338/fwk/core/component.css",
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/standard/component-js-css-servlet-mapping-expected.css", page);
	}
