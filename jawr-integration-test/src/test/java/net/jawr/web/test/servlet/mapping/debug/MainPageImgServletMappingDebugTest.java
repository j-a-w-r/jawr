...
import net.jawr.web.test.servlet.mapping.standard.MainPageImgServletMappingTest;
...
/**
 * Test case for page using Image servlet mapping in debug mode.
 * 
 * @author ibrahim Chaehoi
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/servlet/mapping/config/web-img-servlet-mapping.xml", jawrConfig = "net/jawr/web/servlet/mapping/config/jawr-debug.properties")
public class MainPageImgServletMappingDebugTest extends MainPageImgServletMappingTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/servlet/mapping/resources/debug/index-jsp-result-debug-img-servlet-mapping-expected.txt", page);
