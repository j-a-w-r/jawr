 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/generator/img/standard/config/web.xml", jawrConfig = "net/jawr/web/generator/img/standard/config/jawr.properties")
public class MainPageGeneratedImageTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/img/standard/resources/index-jsp-result-expected.txt", page);
	}
	...
	public void testJsBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/img/standard/resources/msg-bundle.js", page);
	}
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/img/standard/resources/component-expected.css", page);
	}
