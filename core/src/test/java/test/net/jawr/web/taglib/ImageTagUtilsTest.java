...
public class ImageTagUtilsTest extends TestCase {
	...
	public void testImageUrl() {
		...
		String expectedResult = "/basicwebapp/cb90c55a38064627dca337dfa5fc5be120/img/logo/myLogo.png";
		assertEquals(expectedResult, result);

		result = ImageTagUtils.getImageUrl("../img/logo/myLogo.png",
				imgRsHandler, request, response);
		expectedResult = "/basicwebapp/cb90c55a38064627dca337dfa5fc5be120/img/logo/myLogo.png";
		assertEquals(expectedResult, result);
		System.out.println(result);

		result = ImageTagUtils.getImageUrl("./img/logo/myLogo.png",
				imgRsHandler, request, response);
		expectedResult = "/basicwebapp/cb90c55a38064627dca337dfa5fc5be120/content/img/logo/myLogo.png";
		assertEquals(expectedResult, result);
		System.out.println(result);
	...
	private class MockHttpServletRequest implements HttpServletRequest {
		...
		public MockHttpServletRequest(String contextPath, String requestUri) {
