...
/**
 * Interface for composite bundle postprocessors, which will perform different kinds
 * of processing on composite bundle after the processing of each child bundle. 
 * 
 * @author Ibrahim Chaehoi
 */
public interface CompositeResourceBundlePostProcessor extends ResourceBundlePostProcessor {
