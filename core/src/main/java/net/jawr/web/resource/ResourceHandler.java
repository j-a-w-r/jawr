...
public interface ResourceHandler {
	...
	/**
	 * Retrieves the input stream of a temporary resource. 
	 * A temporary resource is a resource generated by the application to manage the resources.
	 *  
	 ...
	 * @param resourceName th name of the resource.  
